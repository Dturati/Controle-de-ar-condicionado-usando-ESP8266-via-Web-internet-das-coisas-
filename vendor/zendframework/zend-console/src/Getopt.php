...
{
    /**
     * The options for a given index can be in multiple formats.
    ...
    /**
     * Stores the command-line arguments for the calling index.
     *
     * @var array
     */
    ...
    /**
     * Stores the name of the calling index.
     *
     * @var string
     */
    protected $progname = '';
    ...
    /**
     * Stores the list of legal options for this index.
     *
     * @var array
     */
     ...
     * of the index, as well as parameters given in options.
     *
     * @var array
     */
     ...
     * current index invocation.  This function returns true, or the
