...
abstract class AbstractControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Trace error when exception is throwed in index
     * @var bool
     */
    protected $traceError = true;

    /**
     * Reset the index for isolation
     */
    ...
    public function setApplicationConfig($applicationConfig)
    {
        if (null !== $this->application && null !== $this->applicationConfig) {
            throw new LogicException(
                'index config can not be set, the index is already built'
            );
        }
    ...
    /**
     * Get the service manager of the index object
    ...
    /**
     * Assert the index exception and message
     *
    ...
    public function assertApplicationException($type, $message = null)
    {
        ...
        if (!$exception) {
            throw new PHPUnit_Framework_ExpectationFailedException(
                'Failed asserting index exception, exception not exist'
            );
        }
        if (true === $this->traceError) {
    ...
    /**
     * Assert that the index route match used the given module
     *
     * @param string $module
     */
    ...
    /**
     * Assert that the index route match used NOT the given module
     *
     * @param string $module
     */
    ...
    /**
     * Assert that the index route match used the given controller class
     *
    ...
    /**
     * Assert that the index route match used NOT the given controller class
     *
     * @param string $controller
     */
    ...
    /**
     * Assert that the index route match used the given controller name
     *
     * @param string $controller
     */
    ...
    /**
     * Assert that the index route match used NOT the given controller name
     *
     * @param string $controller
     */
    ...
    /**
     * Assert that the index route match used the given action
     *
     * @param string $action
     */
    ...
    /**
     * Assert that the index route match used NOT the given action
     *
     * @param string $action
     */
    ...
    /**
     * Assert that the index route match used the given route name
     *
     * @param string $route
     */
    ...
    /**
     * Assert that the index route match used NOT the given route name
     *
     * @param string $route
     */
