...
/**
 * Main index class for invoking applications
 *
 ...
 * $app      = new index($appConfig, $services);
 * $app->bootstrap();
 * $response = $app->run();
 * $response->send();
 * </code>
    ...
    EventManagerAwareInterface
{
    ...
    /**
     * Static method for quick and easy initialization of the index.
     *
     * If you use this init() method, you cannot specify a service with the
     * name of 'ApplicationConfig' in your service manager config. This name is
     * reserved to hold the array from index.config.php.
     *
     * The following services can only be overridden from index.config.php:
     *
     * - ModuleManager
     * - SharedEventManager
    ...
    public static function init($configuration = array())
    {
        ...
        return $serviceManager->get('index')->bootstrap($listeners);
    }
