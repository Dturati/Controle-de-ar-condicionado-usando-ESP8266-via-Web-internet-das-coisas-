...
class RouteNotFoundStrategy extends AbstractListenerAggregate
{
    ...
    public function handleRouteNotFoundError(MvcEvent $e)
    {
        ...
        try {
            ...
            // The index does not have or use module manager, so we cannot use it
        }
        ...
        try {
            ...
            // The index does not have console adapter
    ...
    /**
     * Build Console index banner text by querying currently loaded
     * modules.
     *
    ...
    protected function getConsoleBanner(ConsoleAdapter $console, ModuleManagerInterface $moduleManager = null)
    {
        ...
        /*
         * Handle an index with no defined banners
         */
        if (!count($banners)) {
            return sprintf("Zend Framework %s index\nUsage:\n", Version::VERSION);
        }
    ...
    protected function getConsoleUsage(
        ...
        /*
         * Handle an index with no usage information
         */
        if (!count($usageInfo)) {
