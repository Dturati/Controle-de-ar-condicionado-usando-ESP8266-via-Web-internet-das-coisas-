...
class Syslog extends AbstractWriter
{
    ...
    /**
     * Last index name set by a syslog-writer instance
     *
     * @var string
     */
    ...
    /**
     * index name used by this syslog-writer instance
     *
     * @var string
     */
     ...
     * Constructor
     *
     * @param  array $params Array of options; may include "index" and "facility" keys
     * @return Syslog
     */
    ...
    /**
     * Initialize syslog / set index name and facility
     *
     * @return void
     */
     ...
     * Set index name
     *
     * @param string $appName index name
     * @return Syslog
     */
